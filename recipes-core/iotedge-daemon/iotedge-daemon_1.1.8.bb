...
SRC_URI += " \
    ...
    git://github.com/Azure/hyperlocal-windows;protocol=https;nobranch=1;branch=main;name=hyperlocal-windows;destsuffix=hyperlocal-windows \
    git://github.com/Azure/mio-uds-windows.git;protocol=https;nobranch=1;branch=main;name=mio-uds-windows;destsuffix=mio-uds-windows \
    git://github.com/Azure/tokio-uds-windows.git;protocol=https;nobranch=1;branch=main;name=tokio-uds-windows;destsuffix=tokio-uds-windows \
"
